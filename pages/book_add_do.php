...
//1.图书入库
//语句
$sql = "INSERT INTO ykj_book (cid,ccid,bookname,author,publicer,price,descript,dt,fp) VALUES ($class_pid,$class_cid,'" . $bookname . "','" . $author . "','" . $publicer . "','" . $price . "','" . $descript . "',$dt,$fp)";
//执行语句
$msql->execute($sql);
